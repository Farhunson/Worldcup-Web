...
const officialWcPlayerDatabase = [
  ...
  { number: 13, nameOnShirt: 'LOPES CABRAL', fullName: 'LOPES CABRAL', team: 'Cabo Verde', position: 'DF', club: 'SL Ben ca (POR)' },
  ...
  { number: 7, nameOnShirt: 'DEDIC', fullName: 'DEDIC', team: 'Bosnia and Herzegovina', position: 'DF', club: 'SL Ben ca (POR)' },
  ...
  { number: 11, nameOnShirt: 'ANTONISSE', fullName: 'ANTONISSE', team: 'Curaçao', position: 'FW', club: 'AE Ki sia FC (GRE)' },
  ...
  { number: 21, nameOnShirt: 'CHONG', fullName: 'CHONG', team: 'Curaçao', position: 'MF', club: 'She eld United FC (ENG)' },
