...
const officialSquadPlayers = {
  ...
  'CROSS': 'South Africa',
  'SEUNGGYU': 'Rep. of Korea',
  'HANBEOM': 'Rep. of Korea',
  'GIHYUK': 'Rep. of Korea',
  'MINJAE': 'Rep. of Korea',
  'TAEHYEON': 'Rep. of Korea',
  'INBEOM': 'Rep. of Korea',
  'HEUNGMIN': 'Rep. of Korea',
  'SEUNGHO': 'Rep. of Korea',
  'GUSEUNG': 'Rep. of Korea',
  'JAESUNG': 'Rep. of Korea',
  'HEECHAN': 'Rep. of Korea',
  'BUMKEUN': 'Rep. of Korea',
  'TAESEOK': 'Rep. of Korea',
  'WIJE': 'Rep. of Korea',
  'MOONHWAN': 'Rep. of Korea',
  'JINSEOB': 'Rep. of Korea',
  'JUNHO': 'Rep. of Korea',
  'HYEONGYU': 'Rep. of Korea',
  'KANGIN': 'Rep. of Korea',
  'HYUNJUN': 'Rep. of Korea',
  'HYEONWOO': 'Rep. of Korea',
  'YOUNGWOO': 'Rep. of Korea',
  'JENS': 'Rep. of Korea',
  'JINGYU': 'Rep. of Korea',
  'JISUNG': 'Rep. of Korea',
  'DONGGYEONG': 'Rep. of Korea',
  'RAYA': 'Spain',
  'MARC PUBILL': 'Spain',
  'GRIMALDO': 'Spain',
  'ERIC': 'Spain',
...
const officialWcPlayerDatabase = [
  ...
  { number: 19, nameOnShirt: 'OTAMENDI', fullName: 'OTAMENDI', team: 'Argentina', position: 'DF', club: 'SL Ben ca (POR)' },
  ...
  { number: 14, nameOnShirt: 'LUKEBAKIO', fullName: 'LUKEBAKIO', team: 'Belgium', position: 'FW', club: 'SL Ben ca (POR)' },
  ...
  { number: 6, nameOnShirt: 'RICHARD RIOS', fullName: 'RICHARD RIOS', team: 'Colombia', position: 'MF', club: 'SL Ben ca (POR)' },
  ...
  { number: 24, nameOnShirt: 'MONTERO', fullName: 'MONTERO', team: 'Colombia', position: 'GK', club: 'CA Vélez Sars eld (ARG)' },
  ...
  { number: 12, nameOnShirt: 'RAMIREZ', fullName: 'RAMIREZ', team: 'Ecuador', position: 'GK', club: 'AE Ki sia FC (GRE)' },
  ...
  { number: 4, nameOnShirt: 'BINDON', fullName: 'BINDON', team: 'New Zealand', position: 'DF', club: 'She eld United FC (ENG)' },
  ...
  { number: 14, nameOnShirt: 'AURSNES', fullName: 'AURSNES', team: 'Norway', position: 'MF', club: 'SL Ben ca (POR)' },
  ...
  { number: 21, nameOnShirt: 'SCHJELDERUP', fullName: 'SCHJELDERUP', team: 'Norway', position: 'MF', club: 'SL Ben ca (POR)' },
  ...
  { number: 4, nameOnShirt: 'TOMAS A.', fullName: 'TOMAS A.', team: 'Portugal', position: 'DF', club: 'SL Ben ca (POR)' },
  ...
  { number: 1, nameOnShirt: 'SEUNGGYU', fullName: 'SEUNGGYU', team: 'Rep. of Korea', position: 'GK', club: 'FC Tokyo (JPN)' },
  { number: 2, nameOnShirt: 'HANBEOM', fullName: 'HANBEOM', team: 'Rep. of Korea', position: 'DF', club: 'FC Midtjylland (DEN)' },
  { number: 3, nameOnShirt: 'GIHYUK', fullName: 'GIHYUK', team: 'Rep. of Korea', position: 'MF', club: 'Gangwon FC (KOR)' },
  { number: 4, nameOnShirt: 'MINJAE', fullName: 'MINJAE', team: 'Rep. of Korea', position: 'DF', club: 'FC Bayern München (GER)' },
  { number: 5, nameOnShirt: 'TAEHYEON', fullName: 'TAEHYEON', team: 'Rep. of Korea', position: 'DF', club: 'Kashima Antlers (JPN)' },
  { number: 6, nameOnShirt: 'INBEOM', fullName: 'INBEOM', team: 'Rep. of Korea', position: 'MF', club: 'Feyenoord Rotterdam (NED)' },
  { number: 7, nameOnShirt: 'HEUNGMIN', fullName: 'HEUNGMIN', team: 'Rep. of Korea', position: 'FW', club: 'LAFC (USA)' },
  { number: 8, nameOnShirt: 'SEUNGHO', fullName: 'SEUNGHO', team: 'Rep. of Korea', position: 'MF', club: 'Birmingham City FC (ENG)' },
  { number: 9, nameOnShirt: 'GUSEUNG', fullName: 'GUSEUNG', team: 'Rep. of Korea', position: 'FW', club: 'FC Midtjylland (DEN)' },
  { number: 10, nameOnShirt: 'JAESUNG', fullName: 'JAESUNG', team: 'Rep. of Korea', position: 'MF', club: '1. FSV Mainz 05 (GER)' },
  { number: 11, nameOnShirt: 'HEECHAN', fullName: 'HEECHAN', team: 'Rep. of Korea', position: 'MF', club: 'Wolverhampton Wanderers FC (ENG)' },
  { number: 12, nameOnShirt: 'BUMKEUN', fullName: 'BUMKEUN', team: 'Rep. of Korea', position: 'GK', club: 'Jeonbuk Hyundai Motors FC (KOR)' },
  { number: 13, nameOnShirt: 'TAESEOK', fullName: 'TAESEOK', team: 'Rep. of Korea', position: 'DF', club: 'FK Austria Wien (AUT)' },
  { number: 14, nameOnShirt: 'WIJE', fullName: 'WIJE', team: 'Rep. of Korea', position: 'DF', club: 'Jeonbuk Hyundai Motors FC (KOR)' },
  { number: 15, nameOnShirt: 'MOONHWAN', fullName: 'MOONHWAN', team: 'Rep. of Korea', position: 'DF', club: 'Daejeon Hana Citizen FC (KOR)' },
  { number: 16, nameOnShirt: 'JINSEOB', fullName: 'JINSEOB', team: 'Rep. of Korea', position: 'DF', club: 'Zhejiang FC (CHN)' },
  { number: 17, nameOnShirt: 'JUNHO', fullName: 'JUNHO', team: 'Rep. of Korea', position: 'MF', club: 'Stoke City FC (ENG)' },
  { number: 18, nameOnShirt: 'HYEONGYU', fullName: 'HYEONGYU', team: 'Rep. of Korea', position: 'FW', club: 'Be ş ikta ş  JK (TUR)' },
  { number: 19, nameOnShirt: 'KANGIN', fullName: 'KANGIN', team: 'Rep. of Korea', position: 'MF', club: 'Paris Saint-Germain (FRA)' },
  { number: 20, nameOnShirt: 'HYUNJUN', fullName: 'HYUNJUN', team: 'Rep. of Korea', position: 'MF', club: 'Celtic FC (SCO)' },
  { number: 21, nameOnShirt: 'HYEONWOO', fullName: 'HYEONWOO', team: 'Rep. of Korea', position: 'GK', club: 'Ulsan HD (KOR)' },
  { number: 22, nameOnShirt: 'YOUNGWOO', fullName: 'YOUNGWOO', team: 'Rep. of Korea', position: 'DF', club: 'FK Crvena Zvezda (SRB)' },
  { number: 23, nameOnShirt: 'JENS', fullName: 'JENS', team: 'Rep. of Korea', position: 'DF', club: 'Borussia Mönchengladbach (GER)' },
  { number: 24, nameOnShirt: 'JINGYU', fullName: 'JINGYU', team: 'Rep. of Korea', position: 'MF', club: 'Jeonbuk Hyundai Motors FC (KOR)' },
  { number: 25, nameOnShirt: 'JISUNG', fullName: 'JISUNG', team: 'Rep. of Korea', position: 'MF', club: 'Swansea City AFC (WAL)' },
  { number: 26, nameOnShirt: 'DONGGYEONG', fullName: 'DONGGYEONG', team: 'Rep. of Korea', position: 'MF', club: 'Ulsan HD (KOR)' },
  ...
  { number: 1, nameOnShirt: 'TURNER', fullName: 'TURNER', team: 'USA', position: 'GK', club: 'New England Revolution (USA)' },
  { number: 2, nameOnShirt: 'DEST', fullName: 'DEST', team: 'USA', position: 'DF', club: 'PSV Eindhoven (NED)' },
  { number: 3, nameOnShirt: 'RICHARDS', fullName: 'RICHARDS', team: 'USA', position: 'DF', club: 'Crystal Palace FC (ENG)' },
  { number: 4, nameOnShirt: 'ADAMS', fullName: 'ADAMS', team: 'USA', position: 'MF', club: 'AFC Bournemouth (ENG)' },
  { number: 5, nameOnShirt: 'A. ROBINSON', fullName: 'A. ROBINSON', team: 'USA', position: 'DF', club: 'Fulham FC (ENG)' },
  { number: 6, nameOnShirt: 'TRUSTY', fullName: 'TRUSTY', team: 'USA', position: 'DF', club: 'Celtic FC (SCO)' },
  { number: 7, nameOnShirt: 'REYNA', fullName: 'REYNA', team: 'USA', position: 'MF', club: 'Borussia Mönchengladbach (GER)' },
  { number: 8, nameOnShirt: 'MCKENNIE', fullName: 'MCKENNIE', team: 'USA', position: 'MF', club: 'Juventus FC (ITA)' },
  { number: 9, nameOnShirt: 'PEPI', fullName: 'PEPI', team: 'USA', position: 'FW', club: 'PSV Eindhoven (NED)' },
  { number: 10, nameOnShirt: 'PULISIC', fullName: 'PULISIC', team: 'USA', position: 'FW', club: 'AC Milan (ITA)' },
  { number: 11, nameOnShirt: 'AARONSON', fullName: 'AARONSON', team: 'USA', position: 'FW', club: 'Leeds United FC (ENG)' },
  { number: 12, nameOnShirt: 'M. ROBINSON', fullName: 'M. ROBINSON', team: 'USA', position: 'DF', club: 'FC Cincinnatti (USA)' },
  { number: 13, nameOnShirt: 'REAM', fullName: 'REAM', team: 'USA', position: 'DF', club: 'Charlotte FC (USA)' },
  { number: 14, nameOnShirt: 'BERHALTER', fullName: 'BERHALTER', team: 'USA', position: 'MF', club: 'Vancouver Whitecaps FC (CAN)' },
  { number: 15, nameOnShirt: 'ROLDAN', fullName: 'ROLDAN', team: 'USA', position: 'MF', club: 'Seattle Sounders FC (USA)' },
  { number: 16, nameOnShirt: 'FREEMAN', fullName: 'FREEMAN', team: 'USA', position: 'DF', club: 'Villarreal CF (ESP)' },
  { number: 17, nameOnShirt: 'TILLMAN', fullName: 'TILLMAN', team: 'USA', position: 'MF', club: 'Bayer Leverkusen (GER)' },
  { number: 18, nameOnShirt: 'ARFSTEN', fullName: 'ARFSTEN', team: 'USA', position: 'DF', club: 'Columbus Crew (USA)' },
  { number: 19, nameOnShirt: 'WRIGHT', fullName: 'WRIGHT', team: 'USA', position: 'FW', club: 'Coventry City FC (ENG)' },
  { number: 20, nameOnShirt: 'BALOGUN', fullName: 'BALOGUN', team: 'USA', position: 'FW', club: 'AS Monaco (FRA)' },
  { number: 21, nameOnShirt: 'WEAH', fullName: 'WEAH', team: 'USA', position: 'FW', club: 'Olympique Marseille (FRA)' },
  { number: 22, nameOnShirt: 'MCKENZIE', fullName: 'MCKENZIE', team: 'USA', position: 'DF', club: 'Toulouse FC (FRA)' },
  { number: 23, nameOnShirt: 'SCALLY', fullName: 'SCALLY', team: 'USA', position: 'DF', club: 'Borussia Mönchengladbach (GER)' },
  { number: 24, nameOnShirt: 'FREESE', fullName: 'FREESE', team: 'USA', position: 'GK', club: 'New York City FC (USA)' },
  { number: 25, nameOnShirt: 'BRADY', fullName: 'BRADY', team: 'USA', position: 'GK', club: 'Chicago Fire FC (USA)' },
  { number: 26, nameOnShirt: 'ZENDEJAS', fullName: 'ZENDEJAS', team: 'USA', position: 'FW', club: 'Club América (MEX)' },
